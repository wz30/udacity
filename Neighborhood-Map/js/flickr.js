...
function getFlickrImages() {
		var flickrUrl = 'https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=AIzaSyBlA9LiSRwQ0uD23UJyg3jSk5E7utp02AY&text=National+Mall&accuracy=16&lat=38.896952&lon=-77.029713&format=json';
        $.ajax({
            url: flickrUrl,
            dataType: 'jsonp',
            jsonp: 'jsoncallback',

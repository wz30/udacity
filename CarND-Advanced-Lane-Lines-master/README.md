...
- When I fail to generate the results you expected, it is really painful to find the errors and issues. My stragety is to coed sepearetly and test each function and combine 